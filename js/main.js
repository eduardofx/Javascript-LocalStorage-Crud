...
function setList(list){
    ...
    for(var key in list){
        table += '<tr><td>'+ formatDesc(list[key].desc) +'</td><td>'+ parseInt(list[key].amount) +'</td><td>'+ formatValue(list[key].value) +'</td><td><button class="btn btn-default" onclick="setUpdate('+key+');" >Editar</button>  <button class="btn btn-default" onclick="deleteData('+key+');" >Apagar</button></td></tr>';
    }
    table += '</tbody>';
